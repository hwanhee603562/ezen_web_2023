...
public class Part1 {
	...
	while(true) {
		...
		if(ch == 1) {
			if(콜라재고 <= 0) {
				System.out.println("콜라재고가 없습니다[ 관리자에게 문의 ]");
			} else {
			...
			if(환타재고 <= 0) {
				System.out.println("사이다재고가 없습니다[ 관리자에게 문의 ]");
			} else {
			...
			int ch2 = sc.nextInt();
			if(ch2 == 1) {
				System.out.println("안내금액투여 : "+((콜라바구니*콜라가격)+(환타바구니*환타가격)+(사이다바구니*사이다가격)));
				System.out.println("금액입력해주세요 : ");
				int ch3 = sc.nextInt();
				if(ch3<((콜라바구니*콜라가격)+(환타바구니*환타가격)+(사이다바구니*사이다가격))) {
					...
					System.out.println("잔액"+(ch3-((콜라바구니*콜라가격)+(환타바구니*환타가격)+(사이다바구니*사이다가격))));
					콜라바구니 = 0;
					환타바구니 = 0;
					사이다바구니 = 0;
