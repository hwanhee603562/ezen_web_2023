...
<body>
	...
	<div class="webcontent">
		<div class="productBox">
			...
			<!-- 탭스start  -->
			<!--1. 탭 목록 -->
			<ul class="mt-5 nav nav-tabs nav-pills nav-fill" id="myTab"
				role="tablist">
				<!-- 탭 1개 항목 data-bs-target : 탭버튼을 클릭했을때 활성화 되는 탭내용의 id -->
				<li class="nav-item" role="presentation">
					<button class="nav-link active" id="home-tab" data-bs-toggle="tab"
						data-bs-target="#navTab1" type="button" role="tab"
				...
				<li class="nav-item" role="presentation">
					<button class="nav-link" id="profile-tab" data-bs-toggle="tab"
						data-bs-target="#navTab2" type="button" role="tab"
				...
				<li class="nav-item" role="presentation">
					<button class="nav-link" id="contact-tab" data-bs-toggle="tab"
						data-bs-target="#navTab3" type="button" role="tab"
				...
				<li class="nav-item" role="presentation">
					<button class="nav-link" id="disabled-tab" data-bs-toggle="tab"
						data-bs-target="#navTab4" type="button" role="tab"
			...
			<div class="mb-5 tab-content" id="myTabContent">
				<div class="tab-pane fade show active" id="navTab1" role="tabpanel"
					aria-labelledby="home-tab" tabindex="0">제품위치 출력되는 구역</div>
				<div class="tab-pane fade" id="navTab2" role="tabpanel"
					aria-labelledby="profile-tab" tabindex="0">제품후기 출력되는 구역</div>
				<div class="tab-pane fade" id="navTab3" role="tabpanel"
					aria-labelledby="contact-tab" tabindex="0">QnA 출력되는 구역</div>
				<div class="tab-pane fade" id="navTab4" role="tabpanel"
					aria-labelledby="disabled-tab" tabindex="0">구매 유의사항 출력되는 구역</div>
			</div>
