...
public class Ex2_예제 {
	public static void main(String[] args) {
		...
		map.put("홍길동", 90);	
		map.put("동장군", 80);
		map.put("홍길동", 95);	// key 중복불가능, value : 중복가능 // key 중복일 경우 새로운 값으로 대체 [ "신용권", 85 ] 삭제
		...
		System.out.println( "map객체 내 모든 key : "+map.keySet() );
		System.out.println("map객체 내 모든 values : "+map.values());
		
		// 5. 향상된 for문
			// [ map.keySet() : 모든 key 호출 ]
