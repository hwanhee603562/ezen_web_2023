...
---------------------------------------------------------------------------------------------------------
	<연산자>
		...
		4. 기타 
			...
			where 필드명 in( 값1 , 값2 , 값3 )
			where 필드명 like '%값%'			% : 모든 문자 수 대응 	
			where 필드명 like '_값_'			_ : _ 개수만큼 문자 수 대응 
			where 필드명 is null			null 이면 		[* 필드명 = null 사용 불가 ]
			where 필드명 not null			null 아니면 
---------------------------------------------------------------------------------------------------------
	<기타기워드>
